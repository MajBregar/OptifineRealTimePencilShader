...
void main() {
    ...
    shading_color = blend_function(min(contour, shading_color), contour, 1.0);
    ...
    vec3 background_color = vec3(float(200) / 256.0, float(164) / 256.0, float(130) / 256.0);
    
    vec3 texturing_color = b* paper_texture_color + (1.0 - b) * background_color;
